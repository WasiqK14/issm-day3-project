    ...
    <div className='mt-10 bg-[#252429] p-20'>
        <div className='grid lg:grid-cols-2 gap-5'>
            ...
            <div className='w-full p-5'>
                ...
                <p className='mt-5 text-[#DEC7AC] font-sans text-[16px]'>At Link, strong environmental, social and governance (ESG) practices are core to our identity as a firm. Our 2021 ESG report recaps our progress during the calendar year and shows how we will continue to redefine what sustainability looks like in the industrial real estate sector.</p>
        ...
        <div className='mt-20 grid lg:grid-cols-2 gap-5'>
            ...
            <div className='w-full p-5'>
                <span className='text-[#DEC7AC] font-sans font-semibold text-[32px]'>National scale, local service.</span>
                <p className='mt-5 text-[#DEC7AC] font-sans text-[16px]'>Our large footprint in gateway cities, key distribution hubs and high-population growth areas enable us to provide world-class, personalized service throughout the U.S.</p>
                <button className='mt-5 bg-[#EB6547]  rounded-tl-[30px] hover:bg-[#F49684] w-[250px] h-[50px]'>
                    VIEW OUR PORTFOLIO
                </button>
            </div>
        ...
        <div className='mt-20 grid lg:grid-cols-2 gap-5'>
            ...
            <div className='w-full p-5'>
                <span className='text-[#DEC7AC] font-sans font-semibold text-[32px]'>We design and build warehouses that allow our customers to evolve.</span>
                <p className='mt-5 text-[#DEC7AC] font-sans text-[16px]'>Link seamlessly manages the entire process of delivering facilities that support our customers’ long-term growth strategies.</p>
                <button className='mt-5 bg-[#EB6547]  rounded-tl-[30px] hover:bg-[#F49684] w-[250px] h-[50px]'>
                    LEARN MORE
                </button>
            </div>
